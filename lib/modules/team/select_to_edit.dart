...
class TeamLSelectorEdit extends StatefulWidget {

  TeamLSelectorEdit({Key? key}) : super(key: key);

  @override
  State<TeamLSelectorEdit> createState() => _TeamLSelectorEditState();
}

class _TeamLSelectorEditState extends State<TeamLSelectorEdit> {
  ShowTeamController showTeamController = ShowTeamController();
  EditSubtaskProvider editSubtaskProvider=EditSubtaskProvider();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: Consumer<EditSubtaskProvider>(
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).pushReplacement( //new
                      new MaterialPageRoute( //new
                          settings: const RouteSettings(name: '/addsubtask'),
                          //new
                          builder: (context) => new EditSubtask() //new
                      ) //new
                  );
                },
              );
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Consumer<EditSubtaskProvider>(
                          builder: (context,esp,child) {
                            return ElevatedButton(
                              onPressed: () {

                                esp.savingSelectedItems(selectedItem);
                                if(esp.l.length==0)
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                    backgroundColor: pu,
                                    content: Text('selected '+'${esp.l.length}'+' users'),
